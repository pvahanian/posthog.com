...
If a customer has struggled to get help or fast responses, take accountability first. Acknowledgment that we dropped the ball is how we build trust instead of acting like it didn't happen. Then make sure it can't repeat by setting up alerts on their messages and tickets so surface immediately.
